...
import com.example.e_buy.Model.Cart;
import com.example.e_buy.Prevalent.Prevalent;
import com.example.e_buy.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull Cart model)
            {
                ...
                int oneTypeProductTPrice = oneProductPrice * oneProductQuantity;

                overTotalPrice = overTotalPrice + oneTypeProductTPrice;
                txtTotalAmount.setText(String.valueOf("Total Price = Rs. " +overTotalPrice));
            ...
            public void onDataChange(@NonNull @NotNull  DataSnapshot snapshot) {
                ...
                if(snapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Congratulation, final order has been Shipped successfully");
